...
public class BasicTest {
    private Basic solution = new Basic();
    ...
    public void testlargestOfFour()throws Exception{
        assertArrayEquals(new long[]{5,27,39,1001},solution.largestOfFour(new int[][]{
                {4,5,1,3},
                {13,27,18,26},
                {32,35,37,39},
                {1000,1001,857,1}
        }));
        assertArrayEquals(new long[]{9,35,97,1000000},solution.largestOfFour(new int[][]{
                {4,9,1,3},
                {13,35,18,26},
                {32,35,97,39},
                {1000000,1001,857,1}
    ...
    public void truncateString() throws Exception {
        ...
        assertEquals("A-tisket a-tasket A green and yellow basket",solution.truncateString("A-tisket a-tasket A green and yellow basket", "A-tisket a-tasket A green and yellow basket".length()));
    ...
    public void chunkArrayInGroups() throws Exception {
        assertArrayEquals(new Object[][]{
                {"a", "b"},
                {"c", "d"},
                }, solution.chunkArrayInGroups(new Object[]{"a", "b", "c", "d"}, 2));
        assertArrayEquals(new Object[][]{
                {0,1,2},
                {3,4,5},
    ...
    public void bouncer() throws Exception {
        ...
        assertArrayEquals(new Object[]{}, solution.bouncer(new Object[]{false, null, 0, "NaN", "undefined", ""}));
        assertArrayEquals(new Object[]{1, 2}, solution.bouncer(new Object[]{1, null, "NaN", 2, "undefined"}));
    ...
    public void destroyer() throws Exception {
        ...
        assertArrayEquals(new Object[]{"hamburger"}, solution.destroyer(new Object[]{"tree", "hamburger", 53}, "tree", 53));
    }
